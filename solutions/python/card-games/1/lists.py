...
def get_rounds(number):
    ...
    rounds=[round(number),round(number+1),round(number+2)]
    return rounds
...
def approx_average_is_average(hand):
    ...
    middle=len(hand)//2
    approx_avg_1=(hand[0]+hand[-1])/2
    approx_avg_2=hand[middle]
    if (calculated_average==approx_avg_1 or calculated_average==approx_avg_2):
        return True
    else: return False
